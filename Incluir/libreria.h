...
public:
    ...
    PolizaCasa(){
        ...
        std::cout << "------ POLIZA DE CASA ------" << std::endl << "| Datos Generales |" << std::endl << "Nombre Completo: " << Nombre << std::endl << "CURP: " << CURP << std::endl << "Día de Nacimiento: " << DayBirth << std::endl << "Edad: " << Edad << "El Monto Máximo que se le va a otorgar es de: " << MontoMax << std::endl << "Su Deducible Final será de: " << Deducible;
...
public:
    ...
    PolizaVida(){
        ...
        std::cout << "------ POLIZA DE VIDA ------" << std::endl << "| Datos Generales |" << std::endl << "Nombre Completo: " << Nombre << std::endl << "CURP: " << CURP << std::endl << "Día de Nacimiento: " << DayBirth << std::endl << "Edad: " << Edad << "El Monto Máximo que se le va a otorgar es de: " << MontoMax << std::endl << "Su Deducible Final será de: " << Deducible;
...
public:
    ...
    PolizaCarro(){
        ...
        std::cout << "Color: ";
        std::cin >> this->Color;
        std::cout << "------ POLIZA DE CARRO ------" << std::endl << "| Datos Generales |" << std::endl << "Nombre Completo: " << Nombre << std::endl << "CURP: " << CURP << std::endl << "Día de Nacimiento: " << DayBirth << std::endl << "Edad: " << Edad << "El Monto Máximo que se le va a otorgar es de: " << MontoMax << std::endl << "Su Deducible Final será de: " << Deducible;
